...
export const LoginForm = () => {
  ...
  return (
    <div className="mx-auto flex w-full flex-col items-center self-center justify-center sm:flex-row">
      {/* Brand Header */}
      <div className="my-8 text-center sm:w-[500px]">
        ...
        <p className="text-muted-foreground mt-1">
          Advanced Cardiac Imaging Platform
        </p>
      </div>
      ...
      <div className="bg-card border-border mx-4 overflow-hidden rounded-2xl border shadow-xl sm:my-3 sm:h-[610px] sm:w-[500px]">
        <CardHeader className="from-muted/50 to-muted/30 border-border/50 border-b bg-gradient-to-r pt-6">
          ...
          <CardDescription>
            Access your cardiac segmentation workspace and projects
          </CardDescription>
        </CardHeader>
          ...
          <div className="px-6 pb-6">
            <div className="relative mb-6">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <span className="bg-card text-muted-foreground px-4 text-sm font-medium">
                  Alternative Options
                </span>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <Link href="/register" className="block">
                <Button
                  type="button"
                  variant="outline"
                  className="hover:bg-muted/50 h-11 w-full border-2 text-base font-medium transition-all duration-200 hover:cursor-pointer"
                  disabled={loading}
                >
                    ...
                    <AlertDialogDescription className="mt-4 space-y-4 text-left">
                      <div className="rounded-lg border border-orange-200 bg-orange-50 p-4 dark:bg-orange-950/20">
                        ...
                        <ul className="space-y-1 text-sm text-orange-700 dark:text-orange-300">
                          <li>
                            • Full access to all brushing tools and exports
                          </li>
                          <li>
                            • Real-time cardiac segmentation via Artificial
                            Intelligence
                          </li>
                      ...
                      <div className="rounded-lg border border-red-200 bg-red-50 p-4 dark:bg-red-950/20">
                        ...
                        <ul className="space-y-1 text-sm text-red-700 dark:text-red-300">
                          <li>
                            • Projects are temporary and will be deleted at 3am
                            daily
                          </li>
                      ...
                      <div className="bg-muted/50 rounded-lg p-3 text-center">
                        <p className="text-sm font-medium">
                          💡 Create a free account to save your valuable work -
                          only 2 minutes!
                        </p>
                      </div>
                    </AlertDialogDescription>
                  ...
                  <AlertDialogFooter className="flex-col space-y-2 sm:flex-row sm:space-y-0 sm:space-x-2">
                    ...
                    <div className="flex w-full gap-2 sm:w-auto">
                      ...
                      <Button
                        ...
                        disabled={loading}
                        className="h-10 flex-1 bg-gradient-to-r from-orange-500 to-amber-500 hover:from-orange-600 hover:to-amber-600"
                      >
            ...
            <div className="border-border/50 mt-6 border-t pt-4 text-center">
              <p className="text-muted-foreground text-sm">
                Secure Storage • Smart Segmentation • Simple Solutions
              </p>
            </div>
          </div>
        </form>
