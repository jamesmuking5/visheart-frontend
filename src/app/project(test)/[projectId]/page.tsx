      ...
      <div className="max-w-6xl mx-auto space-y-4">
        <div className="bg-card text-card-foreground rounded-lg border p-6">
          ...
          <div className="flex gap-4">
            <button onClick={() => router.push(`/project(test)/${projectId}/preview`)} className="bg-primary text-primary-foreground hover:bg-primary/90 px-4 py-2 rounded-md transition-colors">
              Go to Preview
            </button>
