...
export default function AnalyticsDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-xl font-semibold text-white dark:text-gray-100">AWS Analytics Dashboard</h1>
                <p className="text-sm text-gray-300 dark:text-gray-400">Monitor your cloud infrastructure</p>
              </div>
            </div>
            <div className="flex items-center space-x-2">
              <Shield className="h-5 w-5 text-green-400" />
              <span className="text-sm text-green-400 dark:text-green-300">Secure</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="flex">
        {/* AWS-style Sidebar */}
        <div className="w-56 bg-[#1A202C] dark:bg-[#1A202C] text-white min-h-screen shadow-xl transition-colors border-r border-gray-200 dark:border-[#2D3748]">
          <div className="p-6">
                ...
                return (
                  <Link
                    ...
                    className={`group flex items-center px-3 py-2 text-sm font-medium rounded-md transition-all duration-200 ${
                      item.active
                        ? 'bg-[#FF9900] text-[#232F3E] dark:text-[#0F1419] shadow-lg'
                        : 'text-gray-300 dark:text-gray-300 hover:bg-gray-700 dark:hover:bg-[#2D3748] hover:text-white dark:hover:text-white'
                    }`}
                  >
                    <Icon className={`mr-3 h-5 w-5 ${item.active ? 'text-[#232F3E] dark:text-[#0F1419]' : item.color}`} />
                    {item.name}
                    {item.active && (
                      <div className="ml-auto w-2 h-2 bg-[#232F3E] dark:bg-[#0F1419] rounded-full"></div>
                    )}
                  </Link>
                );
              })}
            ...
            <div className="mt-8 p-3 bg-gray-800 dark:bg-[#212B36] rounded-lg transition-colors border border-gray-700 dark:border-[#2D3748]">
              <div className="flex items-center space-x-2">
                <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse"></div>
                <span className="text-xs text-gray-300 dark:text-gray-300">All services operational</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex-1 pl-6 pr-6">
          <div className="w-full">
            ...
            {/* Header Section */}
            <div className="mb-8">
              <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2 transition-colors">Analytics Dashboard</h1>
            ...
            <div className="mt-12 p-6 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 transition-colors">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  <div className="flex items-center space-x-2">
                    <TrendingUp className="h-5 w-5 text-[#FF9900]" />
                    <span className="text-sm font-medium text-gray-900 dark:text-white transition-colors">Real-time Monitoring</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Database className="h-5 w-5 text-green-500" />
                    <span className="text-sm font-medium text-gray-900 dark:text-white transition-colors">CloudWatch Integration</span>
                  </div>
                </div>
